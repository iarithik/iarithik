...
_*Independent Project*_
    ...
    *   **Energy Minimization:** Utilized gradient-based optimization (via JAX/Optax) to iteratively update the circuit parameters, successfully converging the simulated energy to the exact Full Configuration Interaction (FCI) limit.
...
_*[Womanium & WISER Quantum Program 2025](https://www.thewiser.org/) | Team project of 3 members*_
    ...
    *   **Corrections to ([Carney & Varcoe, 2022](https://arxiv.org/abs/2202.01735)) Paper:** Identified and documented multiple discrepancies between the reference paper's stated derivations and the correct theoretical predictions for specific interference configurations; recorded corrections in a dedicated GitHub repository. See: [github.com/iarithik/Corrections-to-Universal-Statistical-Simulator-arXiv-2202.01735](https://github.com/iarithik/Corrections-to-Universal-Statistical-Simulator-arXiv-2202.01735)
